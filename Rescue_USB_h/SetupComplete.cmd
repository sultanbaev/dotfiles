...
FOR /f "tokens=2" %%i IN ('ECHO list volume ^| DISKPART ^| FINDSTR /e "‘ЁбвҐ¬­л"') DO SET sysvol=%%i
FOR /f "tokens=2" %%i IN ('ECHO list volume ^| DISKPART ^| FINDSTR /e /c:"‘Єалвл© "') DO SET sysvol=%%i
